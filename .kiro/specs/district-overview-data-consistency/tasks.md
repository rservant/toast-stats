...
- [ ] 1. Update PerformanceTargetsData type
  - [ ] 1.1 Add paidClubsCount field to PerformanceTargetsData interface
...
- [ ] 2. Fix isClubDistinguished method in AreaDivisionRecognitionModule
  - [ ] 2.1 Add calculateNetGrowth helper method
    - Add private method to calculate net growth from club data
    - Handle missing membershipBase gracefully (default to 0)
    - _Requirements: 2.1, 2.2_
  
  - [ ] 2.2 Update isClubDistinguished to use full DCP criteria
  ...
  - [ ] 2.3 Write property test for distinguished club criteria
  ...
  - [ ] 2.4 Write unit tests for distinguished club boundary conditions
    - Test all threshold boundaries per design document table
    - Name each test after the rule being protected
    - _Requirements: 2.1, 2.2_

- [ ] 3. Update computePerformanceTargets to include paidClubsCount
  - [ ] 3.1 Add paidClubsCount to return object
    - Use existing `totalPaidClubs` calculation from area recognitions
    - Include in the return object
    - _Requirements: 1.2_
  
  - [ ] 3.2 Write unit tests for paidClubsCount computation
...
- [ ] 4. Update transformation layer
  - [ ] 4.1 Update transformPerformanceTargets to use paidClubsCount
    - Change `current: 0` to `current: performanceTargets.paidClubsCount`
    - Remove the comment about hardcoded value
    - _Requirements: 1.3_
  
  - [ ] 4.2 Write unit tests for transformation
    - Test pass-through of paidClubsCount value
    - Test zero value handling
    - _Requirements: 1.3_

- [ ] 5. Add round-trip serialization property test
  - [ ] 5.1 Write property test for PerformanceTargetsData serialization
...
- [ ] 7. Update existing tests
  - [ ] 7.1 Update AnalyticsComputer.performanceTargets.test.ts
