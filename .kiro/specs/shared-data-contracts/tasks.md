...
- [ ] 1. Create shared-contracts package structure
  - [ ] 1.1 Initialize package at `packages/shared-contracts/`
  ...
  - [ ] 1.3 Add package to workspace
    - Update root package.json workspaces array
    - Add build and test scripts to root package.json
    - _Requirements: 1.1_

- [ ] 2. Implement file format types
  - [ ] 2.1 Create DistrictStatisticsFile types
  ...
  - [ ] 2.2 Create PerDistrictData type
  ...
  - [ ] 2.3 Create AllDistrictsRankingsData types
...
- [ ] 3. Implement Zod validation schemas
  - [ ] 3.1 Create DistrictStatisticsFile schemas
...
- [ ] 4. Implement validation helpers and version constants
  ...
  - [ ] 4.3 Create package entry point
    - Create `src/index.ts`
    - Export all types, schemas, validators, and version constants
    - _Requirements: 1.2_

- [ ] 5. Checkpoint - Build and verify package
...
- [ ] 6. Add unit tests
  - [ ] 6.1 Write version compatibility tests
  ...
  - [ ] 6.2 Write error message quality tests
  ...
  - [ ] 6.3 Write property test for schema-type consistency
  ...
  - [ ] 6.4 Write property test for validation round-trip
...
- [ ] 8. Migrate scraper-cli to use shared contracts
  - [ ] 8.1 Add shared-contracts dependency to scraper-cli
    - Update `packages/scraper-cli/package.json`
    - Add `@toastmasters/shared-contracts` as dependency
    - _Requirements: 7.1_
  
  - [ ] 8.2 Update TransformService imports
  ...
  - [ ] 8.3 Add validation before file writes
...
- [ ] 9. Migrate backend to use shared contracts
  - [ ] 9.1 Add shared-contracts dependency to backend
    - Update `backend/package.json`
    - Add `@toastmasters/shared-contracts` as dependency
    - _Requirements: 8.1_
  
  - [ ] 9.2 Update SnapshotStore imports
    - Import PerDistrictData, SnapshotManifest, AllDistrictsRankingsData from shared-contracts
    - Remove local interface definitions that duplicate shared contracts
    - Update type annotations to use shared types
    - _Requirements: 8.2, 8.3_
  
  - [ ] 9.3 Create adapter for DistrictStatistics
  ...
  - [ ] 9.4 Add validation after file reads
    - Import validation helpers from shared-contracts
  ...
  - [ ] 9.5 Write unit tests for adapter function
