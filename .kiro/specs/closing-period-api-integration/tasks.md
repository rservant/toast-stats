...
- [x] 1. Add Closing Period Detection to RefreshService
...
- [x] 3. Modify PerDistrictSnapshotStore for Override Date
...
- [x] 3.1 Write property test for snapshot dating
...
- [x] 4. Add Snapshot Comparison Logic
...
- [x] 4.1 Write property test for newer-data-wins logic
  - **Property 3: Newer Data Wins**
  - Generate update scenarios and verify correct overwrite behavior
  - **Validates: Requirements 2.3, 2.4**

- [x] 5. Integrate Closing Period Logic into RefreshService
...
- [x] 5.1 Write property test for no new-month snapshots
  - **Property 4: No Misleading New-Month Snapshots**
  - Generate closing period scenarios and verify no snapshot in new month
  - **Validates: Requirements 3.1**

- [x] 6. Checkpoint - Ensure core snapshot logic tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Update API Response Metadata
...
- [x] 8.1 Write unit tests for API fallback behavior
