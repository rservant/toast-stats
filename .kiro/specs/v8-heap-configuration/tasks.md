...
- [x] 1. Configure NODE_OPTIONS in Dockerfile
...
- [ ] 2. Implement HeapValidator module
  - [x] 2.1 Create `backend/src/utils/heapValidator.ts`
  ...
  - [x] 2.2 Write unit tests for HeapValidator
...
- [x] 3. Implement MemoryMonitor module
  - [x] 3.1 Create `backend/src/utils/memoryMonitor.ts`
  ...
  - [x] 3.2 Write unit tests for MemoryMonitor
