...
- [ ] 1. Fix FileSnapshotStore empty directory handling
  - [~] 1.1 Add directory existence check in `findLatestSuccessfulByScanning()`
  ...
  - [ ] 1.2 Write unit tests for empty directory handling
...
- [ ] 2. Update shared.ts to use StorageProviderFactory
  - [ ] 2.1 Replace FileSnapshotStore with StorageProviderFactory
  ...
  - [ ] 2.2 Update service initialization to use storage provider
  ...
  - [ ] 2.3 Write integration tests for storage provider selection
...
- [ ] 3. Checkpoint - Verify storage provider integration
...
- [ ] 4. Verify error response consistency
  - [ ] 4.1 Review existing error handling in route handlers
  ...
  - [ ] 4.2 Write tests for error response consistency
...
- [ ] 5. Update documentation
  - [ ] 5.1 Update storage-migration-guide.md
