...
- [x] 1. Extend backend ClubTrend type with membership payment fields
...
- [x] 2. Extract membership payment data from CSV in ClubHealthAnalyticsModule
  - [x] 2.1 Add data extraction logic for membership payment fields
  ...
  - [x] 2.2 Populate ClubTrend objects with extracted payment data
    - Update `buildClubTrend` or equivalent method to include new fields
    - _Requirements: 8.1_
  - [x] 2.3 Write property test for CSV field parsing
    - **Property 7: CSV Field Parsing Round-Trip**
    - **Validates: Requirements 8.5, 8.6, 8.7**

- [x] 3. Extend frontend ClubTrend type with membership payment fields
...
- [x] 4. Add column configurations for membership payment columns
  - [x] 4.1 Extend SortField type with new field names
    - Add `'octoberRenewals' | 'aprilRenewals' | 'newMembers'` to SortField union in `frontend/src/components/filters/types.ts`
    - _Requirements: 5.1_
  - [x] 4.2 Add column configurations to COLUMN_CONFIGS array
...
- [x] 5. Implement column rendering in ClubsTable
  - [x] 5.1 Add table header cells for new columns
    - Use ColumnHeader component with new column configs
    - _Requirements: 1.1, 2.1, 3.1_
  - [x] 5.2 Add table body cells for new columns
  ...
  - [x] 5.3 Write property test for column display
    - **Property 1: Membership Payment Column Display**
    - **Validates: Requirements 1.1-1.4, 2.1-2.4, 3.1-3.4**

- [x] 6. Implement sorting for membership payment columns
  - [x] 6.1 Add sort cases for new fields in sortedClubs useMemo
    - Handle octoberRenewals, aprilRenewals, newMembers sort fields
    - Treat undefined as lowest value (sort to end)
    - _Requirements: 5.1, 5.2, 5.3_
  - [x] 6.2 Implement secondary sort by club name for equal values
  ...
  - [x] 6.4 Write property test for secondary sort stability
    - **Property 5: Secondary Sort Stability**
    - **Validates: Requirements 5.4**

- [x] 7. Implement filtering for membership payment columns
  - [x] 7.1 Add filter cases for new fields in useColumnFilters hook
    - Handle numeric range filtering for octoberRenewals, aprilRenewals, newMembers
    - Treat undefined as not matching any range
    - _Requirements: 4.2, 4.3_
  - [x] 7.2 Write property test for numeric range filtering
    - **Property 2: Numeric Range Filtering**
    - **Validates: Requirements 4.2, 4.3**
  - [x] 7.3 Write property test for filter clearing
    - **Property 3: Filter Clearing Restores Full List**
    - **Validates: Requirements 4.4**

- [x] 8. Update CSV export to include membership payment columns
  - [x] 8.1 Add new columns to exportClubPerformance function
...
- [x] 10. Apply visual styling for membership payment columns
