...
// Import types and utilities from sub-modules
import {
...
} from './firestore/FirestoreSnapshotTypes.js'
import {
  isIndexError,
  extractIndexUrl,
} from './firestore/FirestoreIndexUtils.js'

// Re-export types and utilities for backward compatibility
export type {
  FirestoreSnapshotDocument,
  FirestoreDistrictDocument,
  BatchWriteConfig,
  BatchWriteResult,
  IndexHealthResult,
} from './firestore/FirestoreSnapshotTypes.js'
