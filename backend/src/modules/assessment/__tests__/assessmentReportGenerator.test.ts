...
describe('Assessment Report Generator', () => {
  ...
  describe('renderYearEndSummary', () => {
    ...
    it('should calculate summary statistics correctly', () => {
      ...
      expect(
        summary.summary.goals_on_track +
          summary.summary.goals_off_track +
          summary.summary.goals_pending
      ).toBe(3)
    })
    ...
    it('should calculate overall achievement percentage', () => {
      ...
      expect(
        summary.summary.overall_achievement_percentage
      ).toBeGreaterThanOrEqual(0)
      expect(
        summary.summary.overall_achievement_percentage
      ).toBeLessThanOrEqual(100)
      expect(typeof summary.summary.overall_achievement_percentage).toBe(
        'number'
      )
    })
  ...
  describe('validateReportStructure', () => {
    ...
    it('should detect missing required fields', () => {
      ...
      const validation = validateReportStructure(
        incompleteReport as MonthlyReport
      )
