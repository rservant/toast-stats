...
const MONTHLY_DATA: Array<
  Omit<MonthlyAssessment, 'district_number' | 'program_year'>
> = [
  {
    month: 'July',
  ...
  },
  {
    ...
    csp_submissions_ytd: 20,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    month: 'November',
    membership_payments_ytd: 60,
    paid_clubs_ytd: 5,
    distinguished_clubs_ytd: 8,
    csp_submissions_ytd: 25,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    month: 'December',
    membership_payments_ytd: 75,
    paid_clubs_ytd: 6,
    distinguished_clubs_ytd: 10,
  ...
  {
    month: 'January',
    membership_payments_ytd: 85,
    paid_clubs_ytd: 7,
    distinguished_clubs_ytd: 12,
    csp_submissions_ytd: 35,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    month: 'February',
    membership_payments_ytd: 95,
    paid_clubs_ytd: 8,
    distinguished_clubs_ytd: 14,
    csp_submissions_ytd: 40,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    month: 'March',
    membership_payments_ytd: 105,
    paid_clubs_ytd: 9,
    distinguished_clubs_ytd: 16,
  ...
  {
    month: 'April',
    membership_payments_ytd: 112,
    paid_clubs_ytd: 10,
    distinguished_clubs_ytd: 18,
    csp_submissions_ytd: 50,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    month: 'May',
    membership_payments_ytd: 118,
    paid_clubs_ytd: 11,
    distinguished_clubs_ytd: 20,
    csp_submissions_ytd: 55,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    month: 'June',
    membership_payments_ytd: 125,
    paid_clubs_ytd: 12,
    distinguished_clubs_ytd: 22,
    csp_submissions_ytd: 60,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
]
...
const SAMPLE_GOALS: Array<
  Omit<DistrictLeaderGoal, 'id' | 'created_at' | 'updated_at'>
> = [
  {
    district_number: 61,
    program_year: '2024-2025',
...
Verify data:
  ...
  - List files: ls -la ${dataDir}
    ...
    log(
      `Error during seeding: ${error instanceof Error ? error.message : String(error)}`,
      'error'
    )
    process.exit(1)
  }
