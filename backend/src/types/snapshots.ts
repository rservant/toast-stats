...
// Re-export AllDistrictsRankingsData and DistrictRanking from shared-contracts
// These types define the file format for all-districts-rankings.json
// Previously defined locally, now imported from the single source of truth
export type {
