...
export class AnalyticsComputer {
   ...
   */
  calculateMembershipChangeWithBase(
    snapshots,
  ...
  computeLeadershipInsights(districtId, snapshots) {
    ...
    const topPerformingDivisions = insights.summary.topPerformingDivisions.map(
      (div, index) => ({
    ...
    const areasNeedingSupport = this.identifyAreasNeedingSupport(
      insights,
      districtSnapshots
    )
    return {
