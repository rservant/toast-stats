...
export class TimeSeriesDataPointBuilder {
     ...
     */
    calculateTotalMembership(district) {
     ...
     */
    calculateTotalPayments(district) {
     ...
     */
    calculateTotalDCPGoals(district) {
        const clubs = district.clubPerformance ?? [];
        return clubs.reduce((total, club) => {
     ...
     */
    calculateClubHealthCounts(district) {
        const clubs = district.clubPerformance ?? [];
     ...
     */
    calculateDistinguishedTotal(district) {
        const clubs = district.clubPerformance ?? [];
        let total = 0;
        for (const club of clubs) {
