...
export const ErrorDisplay: React.FC<ErrorDisplayProps> = ({
  ...
  if (variant === 'full') {
    return (
      <div className={`min-h-screen bg-gray-100 flex items-center justify-center px-4 ${className}`}>
        <div className="bg-white rounded-lg shadow-md p-8 max-w-md w-full" role="alert">
...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div className={`bg-white rounded-lg shadow-md p-12 text-center ${className}`} role="status">
