                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      max={maxDate}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-hidden focus:ring-2 focus:ring-tm-loyal-blue text-gray-900 bg-white font-tm-body"
                    />
                  </div>
