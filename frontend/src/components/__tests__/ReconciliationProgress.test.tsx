...
describe('ReconciliationProgress', () => {
  ...
  it('displays empty state when no changes provided', () => {
    ...
    expect(
      screen.getByText('No metric changes detected for 2024-10')
    ).toBeInTheDocument()
  })
  ...
  it('formats values correctly based on metric type', () => {
    ...
    render(
      <ReconciliationProgress
        metricChanges={[percentageMetric]}
        targetMonth="2024-10"
      />
    )
  ...
  it('hides minor changes when showDetails is false', () => {
    ...
    expect(
      screen.queryByText('Distinguished Percentage')
  ...
  it('handles only significant changes', () => {
    const significantOnly = mockMetricChanges.filter(
      change => change.isSignificant
    )
    render(
      <ReconciliationProgress
        metricChanges={significantOnly}
        targetMonth="2024-10"
      />
    )
  ...
  it('handles only minor changes', () => {
    ...
    render(
      <ReconciliationProgress metricChanges={minorOnly} targetMonth="2024-10" />
    )
  ...
  it('formats large numbers correctly', () => {
    ...
    render(
      <ReconciliationProgress
        metricChanges={[largeNumberMetric]}
        targetMonth="2024-10"
      />
    )
  ...
  it('handles zero percentage change correctly', () => {
    ...
    render(
      <ReconciliationProgress
        metricChanges={[zeroChangeMetric]}
        targetMonth="2024-10"
      />
    )
