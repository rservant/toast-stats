...
describe('ReconciliationStatus', () => {
  ...
  it('displays correct phase information for stabilizing', () => {
    ...
    render(
      <ReconciliationStatus status={stabilizingStatus} targetMonth="2024-10" />
    )
  ...
  it('displays correct phase information for completed', () => {
    ...
    render(
      <ReconciliationStatus status={completedStatus} targetMonth="2024-10" />
    )
  ...
  it('shows progress bar for active phases', () => {
    ...
    expect(progressBar).toHaveAttribute(
      'aria-label',
      expect.stringContaining('Reconciliation progress')
    )
  })
  ...
  it('calculates progress percentage correctly for different phases', () => {
    ...
    render(
      <ReconciliationStatus status={monitoringStatus} targetMonth="2024-10" />
    )
