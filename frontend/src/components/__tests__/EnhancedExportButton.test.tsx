...
describe('EnhancedExportButton', () => {
  ...
  it('renders with custom label', () => {
    render(
      <EnhancedExportButton onExport={mockOnExport} label="Export Analytics" />
    )
  ...
  it('calls onExport with final data metadata', async () => {
    ...
    render(
      <EnhancedExportButton onExport={mockOnExport} dataStatus={dataStatus} />
    )
  ...
  it('applies custom className', () => {
    render(
      <EnhancedExportButton onExport={mockOnExport} className="custom-class" />
    )
