...
export const AreaPerformanceChart: React.FC<AreaPerformanceChartProps> = ({
  ...
  const areasByDivision = areas.reduce((acc, area) => {
      ...
      <div className="absolute z-10 bg-gray-900 text-white text-xs rounded-lg p-3 shadow-lg pointer-events-none transform -translate-x-1/2 -translate-y-full -mt-2 min-w-[200px]">
        ...
        <div className="space-y-1">
          ...
          <div className="flex justify-between gap-4">
            ...
            <span className="font-medium">{area.averageClubHealth.toFixed(1)} / 10</span>
          </div>
          <div className="flex justify-between gap-4">
            <span className="text-gray-300">Performance Score:</span>
            <span className="font-medium">{area.normalizedScore.toFixed(1)} / 10</span>
          </div>
        </div>
    ...
    <div className="bg-white rounded-lg shadow-md">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h3 className="text-xl font-bold text-gray-900">Area Performance</h3>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-32 flex-shrink-0">
                    ...
                    <div className="text-xs text-gray-500">Div {area.divisionId}</div>
                  </div>
                  ...
                  <div className="flex-1 relative">
                    <div className="h-10 bg-gray-100 rounded-lg overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(area.normalizedScore / maxScore) * 100}%` }}
                      >
      ...
      {!isLoading && areas.length > 0 && viewMode === 'heatmap' && (
        <div className="p-6">
          <div className="space-y-6">
            {Object.entries(areasByDivision).map(([divisionId, divisionAreas]) => (
              <div key={divisionId}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-600">Needs Attention (&lt;3)</span>
              </div>
            </div>
          </div>
          <div className="mt-2 text-xs text-gray-600">
            <span className="font-medium">Note:</span> Performance score is normalized by club count for fair comparison
          </div>
        </div>
      )}
    </div>
