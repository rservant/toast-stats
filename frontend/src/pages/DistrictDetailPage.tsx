          ...
          <div className="container mx-auto px-4 py-4 sm:py-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 sm:p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Detailed Analytics Not Available
              </h3>
              <p className="text-gray-600 mb-6">
                Detailed analytics are not yet available for this district.
                Rankings data can be viewed on the home page.
              </p>
              <button
                onClick={() => navigate('/')}
                className="px-6 py-3 bg-tm-loyal-blue text-white rounded-lg hover:bg-opacity-90 transition-colors font-medium"
              >
